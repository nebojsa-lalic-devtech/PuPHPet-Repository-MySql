...
class EmployeeServiceMysql implements IEmployeeService
{
    ...
    {
        $query = "SELECT * FROM `simple-crud-app-puphpet`.employee";
    ...
    public function createEmployee()
    {
        try {
            if (isset($_POST['Submit']) && $_POST['first_name'] != '' && $_POST['last_name'] != '') {
                $query = "INSERT INTO `simple-crud-app-puphpet`.`employee` (`id`, `first_name`, `last_name`, `email`, `job`) VALUES (:id, :first_name, :last_name, :email, :job)";
    ...
    public function updateEmployee()
    {
        ...
        try {
            if (isset($_POST['Update'])) {
                $query = "UPDATE `simple-crud-app-puphpet`.`employee` SET `first_name`=:first_name, `last_name`=:last_name, `email`=:email, `job`=:job WHERE `id`=:id";
                $execute = array(
                    'id' => $id,
                    'first_name' => $_POST['first_name'] ? $_POST['first_name'] : null,
                    'last_name' => $_POST['last_name'] ? $_POST['last_name'] : null,
